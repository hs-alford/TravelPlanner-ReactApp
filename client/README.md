...
React Destination Application in that:
- Each Destination has id, title, description, published status.
- We can create, retrieve, update, delete Destinations.
- There is a Search bar for finding Destinations by title.
